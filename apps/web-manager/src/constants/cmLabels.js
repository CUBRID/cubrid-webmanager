...
export const CM = {
  ...
  killParamResolveErrorMsg: 'Could not determine which transaction to kill.',
  ...
  pagesPerExtensionDesc: 'Amount of space to add per extension',
  ...
  continueInBackgroundHint: 'Press Confirm to continue this in the background.',
  ...
  reconnect: 'Reconnect',
  reconnectPrompt: 'Your session was disconnected, possibly because the token expired or another user logged into this host. Click Reconnect to try again.',
  editHost: 'Edit Host',
  ...
  applyingConfigTitle: 'Applying Changes',
  ...
  configurationAppliedMsg: (db) => `${db || 'Server'} configuration was saved.`,
  updateRejected: 'Update Failed',
  applyFailedTitle: 'Apply Failed',
  updatingConfigTitle: 'Updating Configuration',
  updatingConfigSubtitle: 'Updating cubrid.conf on the server.',
  ...
  charset: 'Charset',
  synchronizationNotice: 'Notice',
  brokerParamsNotice: 'Broker parameters define how Web Manager connects to the CUBRID Broker. These changes only affect Web Manager\'s connection to this host.',
  lockingSection: 'Locking',
  transactionSection: 'Transaction',
  systemSection: 'System',
  advancedHeuristics: 'Advanced Parameters',
  pagesCountTitle: 'Pages Count',
  physicalSizeLabel: 'Physical Size',
  configPatchRejectedMsg: 'Failed to save the configuration changes.',
  connectionNavLabel: 'Connection',
  serverNavLabel: 'Server',
  autoRestartHaDisabledHint: 'CUBRID always disables auto_restart_server when HA is enabled — an abnormally terminated server should fail over via HA, not restart in place.',
  autoStartHaDisabledHint: 'CUBRID refuses to start an HA-configured database through the plain service autostart list — use HA heartbeat start instead.',
  generalParamsTab: 'General Settings',
  advancedParamsTab: 'Advanced Settings',
  kernelParamsTitle: 'Server Parameters',
  registrySubtitle: (db) => `${db} · Configuration`,
  brokerCharsetConfigDesc: 'Broker and charset configuration for this database',
  deepSystemConfigDesc: 'Deep system configuration for the database',
  ...
  advancedParamsWarning: 'Advanced parameters — changes may affect server stability and performance. Be careful when changing these values.',
  ...
  daily24hCycleLabel: 'Daily (24h cycle)',
  everyDayPreset: 'Every Day',
  clearAllPreset: 'Clear All',
  ...
  queryPlanDeletedTitle: 'Query Plan Deleted',
  queryPlanRemovedMsg: 'The query plan has been deleted.',
  deletionFailed: 'Deletion Failed',
  deleteQueryPlanFailedMsg: 'Failed to delete the query plan.',
  retryDeletion: 'Retry Deletion',
  deleteQueryPlanSubtitle: 'Permanently remove this scheduled query',
  deletingQueryPlanMsg: (id) => `Deleting query plan "${id}".`,
  logsNotPurgedNotice: 'Existing logs generated by this plan will not be deleted, but no new executions will be scheduled.',
  confirmDelete: 'Delete',
  deleteQueryPlanPrompt: 'Delete Query Plan?',
  ...
  extractionProfileDesc: 'Shows the parameter values currently active on the database.',
  ...
  serviceStartRejected: 'Failed to start the service on the host.',
  serviceStopFailed: 'Failed to stop the service. Check the agent logs.',

  confirmStopDatabaseTitle: 'Stop Database',
  confirmStopDatabaseDesc: (dbname) => `Stop database "${dbname}"? Active connections and transactions will be disconnected.`,
  confirmStartDatabaseTitle: 'Start Database',
  confirmStartDatabaseDesc: (dbname) => `Start database "${dbname}"?`,
  confirmStopBrokerTitle: 'Stop Broker',
  confirmStopBrokerDesc: (broker) => `Stop broker "${broker}"? Active client connections through it will be disconnected.`,
  confirmStartBrokerTitle: 'Start Broker',
  confirmStartBrokerDesc: (broker) => `Start broker "${broker}"?`,
  confirmStopAllDatabasesTitle: 'Stop All Databases',
  confirmStopAllDatabasesDesc: 'Stop every database on this host? Active connections and transactions will be disconnected.',
  confirmStartAllDatabasesTitle: 'Start All Databases',
  confirmStartAllDatabasesDesc: 'Start every stopped database on this host?',
  confirmRestartAllDatabasesTitle: 'Restart All Databases',
  confirmRestartAllDatabasesDesc: 'Restart every active database on this host? Active connections and transactions will be disconnected.',
  confirmStopAllBrokersTitle: 'Stop All Brokers',
  confirmStopAllBrokersDesc: 'Stop every broker on this host? Active client connections will be disconnected.',
  confirmStartAllBrokersTitle: 'Start All Brokers',
  confirmStartAllBrokersDesc: 'Start every stopped broker on this host?',
  confirmRestartAllBrokersTitle: 'Restart All Brokers',
  confirmRestartAllBrokersDesc: 'Restart every broker on this host? Active client connections will be disconnected.',
  ...
  storageVolumesRequireOnlineDbMsg: 'Storage volume info is only shown for databases that are currently running on this host.',
  volumeLabel: 'Volume',
  purpose: 'Purpose',
  ...
  patchRejectedMsg: 'Failed to update the backup plan. Please check your settings.',
  ...
  deleteBackupPlanPrompt: 'Delete Backup Plan?',
  ...
  deleteBackupPlanRejectedMsg: 'Failed to delete the backup plan. It is still active.',
  deleteQueryPlanRejectedMsg: 'Failed to delete the query plan. It is still active.',
  ...
  customCapacity: 'Volume Size',
  switchUnit: 'Click to switch unit',
  ...
  noBackupHint: 'Make sure the backup directory is set correctly.',
  ...
  authOrOperationFailedMsg: 'Authentication or operation failed. Please check your credentials and try again.',
  ...
  finalDeleteStepDesc: 'This is the final step. After confirmation, all data for this database will be permanently erased.',
  ...
  // Monitoring / misc
  monitoringSync: 'Refresh Settings',
  ...
  logStreamEmptyMsg: "This log is empty or hasn't started yet.",
  logResolveError: (suffix) => `Log file [${suffix}] was not found in the broker directory.`,
  logRetrievalRefused: 'The host refused the request for logs. Check the broker connection.',
  ...
  usedLabel: 'Used',
  freeLabel: 'Free',
  headroomAvailable: 'free space available',
  usageLabel: 'Usage',
  volumeCategorization: 'Volume Categorization',
  physicalVolumeTopology: 'Volume Layout',
  ...
  selectedInstance: 'Selected Database',
  ...
  deleteHostBullet2: 'Associated configuration profiles will be deleted',
  deleteHostConfirmTitle: (alias) => `Permanently remove "${alias}"?`,
  irreversibleActionNotice: 'This action cannot be undone.',
  ...
  selectedHostsCountLabel: (count) => `${count} hosts selected`,
  moveToGroupMenu: 'Move to Group',
  loginSelectedHosts: 'Login Selected',
  deleteSelectedHosts: 'Delete Selected',
  bulkDeleteHostsConfirmTitle: 'Delete Hosts',
  bulkDeleteHostsConfirmDesc: (count) => `Remove these ${count} host connections? Saved credentials and configuration profiles for each will be deleted. This can't be undone.`,
  bulkDeleteHostsSuccessMsg: (count) => `Deleted ${count} host(s).`,
  bulkDeleteHostsPartialMsg: (successCount, failedCount) => `Deleted ${successCount} host(s). Failed to delete ${failedCount}.`,
  ...
  exportHostsDesc: 'Export hosts to a file. Note: The passwords are not included.',
  importHostsDesc: 'Import hosts from a Web Manager or CUBRID Admin export file.',
  ...
  importFormatHelp: 'Web Manager XML/JSON, CUBRID Admin hosts XML, or legacy desktop .prefs / .properties. Host groups are preserved where the format supports them. Encrypted passwords in .prefs are not imported.',
  ...
  identitySyncFailedMsg: 'Failed to create user. Please check the host connection.',
  ...
  // DropUserModal
  identityPurgedMsg: (username, dbname) => `User @${username} has been deleted from ${dbname}.`,
  purgeRejectedMsg: 'Failed to delete user. The host rejected the request.',

  // MonitoringSettingsPopover
  globalHeartbeat: 'Auto-Refresh',
  resourceDashboard: 'Dashboard',
  syncDbThroughputMsg: 'Refreshes database throughput and disk I/O metrics.',
  brokerInfrastructure: 'Broker',
  propagatesConnectionMsg: 'Refreshes broker connection and load status.',
  ...
  applyLabel: 'Apply',
  runtimeConfiguration: 'Runtime Configuration',
  deployingChanges: 'Applying Changes',
  updateSynchronized: 'Changes Applied',
  ...
  enterpriseSuite: 'Database Administration Tool',
  resetAccessCredentials: 'Reset your password.',
  securityProtocol: 'How It Works',
  ...
  enterEmailInstruction: 'Enter your email to reset your password.',
  recoverySecurityDesc: 'We\'ll help you regain access to your account.',
  recoveryProtocolDesc: 'You\'ll receive a link to reset your password. It expires in 15 minutes.',
  ...
  securityInfrastructure: 'Your account stays secure.',
  ...
  synchronizingRegistry: 'Loading users...',
  noUsersFound: 'No users found',
  managementRegistryEmpty: 'No management users found.',
  ...
  passcodeUpdateNote: 'This changes the CMS account password for the currently logged-in user. It also updates the manager access passcode stored locally for this connection.',
  ...
  synchronizationFailed: 'Failed to save changes.',
  savingChanges: 'Saving Changes',
  creatingUser: 'Creating User',
  updating: 'Updating...',
  creating: 'Creating...',
  ...
  primaryAdminNotice: 'This is the primary administrator account. Its permissions cannot be changed.',
  ...
  synchronizingDataTitle: 'Loading Data',
  fetchingMetricsSubtitle: 'Fetching real-time metrics from the database...',
